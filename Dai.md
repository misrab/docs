...
We live in a world where every asset and currency is at a constant threat of both gradual or sudden loss of value. This pervasive financial insecurity has given rise to a massive hedge industry that strives to achieve a seemingly impossible goal: to provide clients with a virtual asset that cannot lose value relative to the general economy. Despite being highly competetive, the hedging schemes that currently exist fall short of their goal due to high profit margins and the principal-agent problem. Dai is a cryptocurrency with price stability that aims to solve these issues with modern technology; becoming the perfect hedging instrument and a new world currency. The Dai Credit System is a decentralized platform that backs the value of Dai by using digital assets as collateral. MKR is a special digital asset that is used for Risk Management of the Dai Credit System. Contrary to the price stability of Dai, the MKR price is highly volatile because it gives its holders financial exposure to the success and user adoption of Dai, while absorbing the risk of the Dai Credit System. The Zug, Switzerland-based Dai Foundation is responsible for the development of the Dai Credit System to its full potential as an efficient, transparent and permissionless platform for cryptocurrency with price stability. 
...
**Financial Markets: Hedging, Derivatives, Leverage etc:** CDPs will allow for easier leveraged trading. Dai will also be useful as stable and reliable collateral in custom derivate smart contracts, such as options or CFD’s.
...
**Mitigation:** We expect that Dai will actually be quite easy to use for a regular crypto-user. Dai will be a standard Ethereum token adhering to the erc-20 standard and easily available with high liquidity across the ecosystem. 
